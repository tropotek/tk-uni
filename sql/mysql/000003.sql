...
ALTER TABLE institution ADD postcode varchar(16) DEFAULT '' NULL AFTER address;
ALTER TABLE institution ADD country varchar(128) DEFAULT '' NULL AFTER address;
ALTER TABLE institution ADD state varchar(128) DEFAULT '' NULL AFTER address;
ALTER TABLE institution ADD city varchar(128) DEFAULT '' NULL AFTER address;
ALTER TABLE institution ADD street varchar(128) DEFAULT '' NULL AFTER address;
...
ALTER TABLE institution ADD `map_zoom` DECIMAL(4, 2) NOT NULL DEFAULT 14 AFTER postcode;
ALTER TABLE institution ADD `map_lng` DECIMAL(11, 8) NOT NULL DEFAULT 0 AFTER postcode;
ALTER TABLE institution ADD `map_lat` DECIMAL(11, 8) NOT NULL DEFAULT 0 AFTER postcode;
